...
try {
		...
		const ownerNumberr = ["6283807449268@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Helga Ilham_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
denz.sendMessage(from, img, image, { quoted: mek, thumbnail: fs.readFileSync('./denz.jpg')})
break
case 'waifu':
reply(mess.wait)
